...
images_dir = '/home/adam/Pictures/vat/201801/vat'
annotations_dir = '/home/adam/Pictures/vat/201801/vat/annotations'
annotations_csv = open('./vat_annotations.csv', 'w', newline='')
classes_csv = open('./vat_classes.csv', 'w', newline='')
classes = ['code', 'number', 'date', 'check_code', 'buyer', 'seller', 'goods', 'amount_without_tax', 'tax_rate',
           'tax_amount', 'amount_with_tax']
...
for image_file_path in glob.glob(images_dir + '/*.jpg'):
    _, image_file = os.path.split(image_file_path)
